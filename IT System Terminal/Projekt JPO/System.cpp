...
void System::menu(){
 ...
 ╚═╝░░░░░╚═╝╚══════╝╚═╝░░╚══╝░╚═════╝
        ...
        cout<<"\n\n\n 1. Ticket Panel Control";
    cout<<"\n 2. Users Panel Control";
    cout<<"\n 3. Departments Panel Control";
    cout<<"\n 4. Save/Update Databases";
    cout<<"\n 5. Backup All";
    cout<<"\n 9. Exit";
    cout<<"\n\n Your Choice : ";
        int x=choose();
    switch(x)
    {
        ...
        case 5:
        {
            system("mkdir /Users/maciejpiotrowski/Desktop/Backup/Backup`date +'%d-%m-%Y'`");
            system("rm /Users/maciejpiotrowski/Desktop/Backup/Backup`date +'%d-%m-%Y'`/tickets_`date +'%d-%m-%Y'`.txt");
            system("cp /Users/maciejpiotrowski/Desktop/tickets.txt /Users/maciejpiotrowski/Desktop/Backup/Backup`date +'%d-%m-%Y'`/tickets_`date +'%d-%m-%Y'`.txt");
            system("rm /Users/maciejpiotrowski/Desktop/Backup/Backup`date +'%d-%m-%Y'`/tickets_c_`date +'%d-%m-%Y'`.txt");
            system("cp /Users/maciejpiotrowski/Desktop/tickets_c.txt /Users/maciejpiotrowski/Desktop/Backup/Backup`date +'%d-%m-%Y'`/tickets_c_`date +'%d-%m-%Y'`.txt");
            system("rm /Users/maciejpiotrowski/Desktop/Backup/Backup`date +'%d-%m-%Y'`/departments_`date +'%d-%m-%Y'`.txt");
            system("cp /Users/maciejpiotrowski/Desktop/departments.txt /Users/maciejpiotrowski/Desktop/Backup/Backup`date +'%d-%m-%Y'`/departments_`date +'%d-%m-%Y'`.txt");
            system("rm /Users/maciejpiotrowski/Desktop/Backup/Backup`date +'%d-%m-%Y'`/users_`date +'%d-%m-%Y'`.txt");
            system("cp /Users/maciejpiotrowski/Desktop/users.txt /Users/maciejpiotrowski/Desktop/Backup/Backup`date +'%d-%m-%Y'`/users_`date +'%d-%m-%Y'`.txt");
            show_progress_bar(100, "BACKUP");
            break;
